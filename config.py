...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1925950412:AAFqFBejQcFDSHxbq6ZjVnGsm8hygBAN1OI' # Get it from https://t.me/BotFather
    APP_ID = '7218170' # Get it from my.telegram.org/apps
    API_HASH = 'f303a5116fa885043cce5478a8fa919e' # Get it from my.telegram.org/apps
